  ...
  return declare("bgagame.batalladecoronas", ebg.core.gamegui, {
    ...
    setup: function (gamedatas) {
      ...
      for (const player_id in gamedatas.players) {
        const { color } = gamedatas.players[player_id];
        const order = player_id == this.player_id ? 0 : 1;

        document.getElementById("boc_castles").insertAdjacentHTML(
          "afterbegin",
          `<div
      ...
      >
        ...
        <div id="boc_castle" class="boc_castle">
          ...
          <div
            id="boc_defense:${player_id}"
            class="boc_defense"
            data-militia="DEFENSE"
            data-area="DEFENSE"
          >
            <div id="boc_rage:${player_id}" class="boc_rage">
              <div class="mo-fire">
              <!-- Copyright (c) 2024 by Tahina (https://codepen.io/tahina/pen/WRXNwQ) -->
              ${svg}
              </div>
            </div>
          ...
          >
            ...
            <div id="boc_sword$${player_id}:6" class="boc_sword_6"></div>
          </div>
          <div id="boc_church:${player_id}" class="boc_church">
            ...
            ></div>
            <div
              id="boc_clergy$${player_id}:2"
              class="boc_clergy_BLUE"
              data-clergy="2"
            ></div>
            <div
              id="boc_clergy$${player_id}:3"
          ...
          <div id="boc_dragon:${player_id}" class="boc_dragon" data-area="DRAGON">
